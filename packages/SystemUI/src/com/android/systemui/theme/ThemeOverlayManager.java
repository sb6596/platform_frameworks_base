...
class ThemeOverlayManager {
    ...
    @VisibleForTesting
    static final String OVERLAY_CATEGORY_STYLE_ANDROID = "android.theme.customization.ui_style.android";
    @VisibleForTesting
    static final String OVERLAY_CATEGORY_STYLE_SETTINGS = "android.theme.customization.ui_style.settings";
    @VisibleForTesting
    static final String OVERLAY_CATEGORY_STYLE_SYSUI = "android.theme.customization.ui_style.systemui";
    @VisibleForTesting
