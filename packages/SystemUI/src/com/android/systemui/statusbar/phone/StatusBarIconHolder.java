...
public class StatusBarIconHolder {
    ...
    public static final int TYPE_NETWORK_TRAFFIC_HEADER = 43;
    ...
    public static StatusBarIconHolder fromNetworkTrafficHeader() {
        StatusBarIconHolder holder = new StatusBarIconHolder();
        holder.mType = TYPE_NETWORK_TRAFFIC_HEADER;
        return holder;
    }
